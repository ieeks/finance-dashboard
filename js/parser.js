...
import { SUBSCRIPTION_RULES, RECURRING_RULES } from './categories.js?v=1.9.7';
import { OWNERS, matchOwner, OWNER_HEADER_RE } from './owners.js?v=1.9.7';
import { LANDLORD } from './personalConfig.js?v=1.9.7';
