// VERBATIM-Kopie von js/matcher.js aus main (v1.11.0) — Referenz für den
// Vergleich in scripts/match_rate_report.mjs. NICHT bearbeiten und nicht aus
// der App importieren; wird beim nächsten Matcher-Release neu gezogen via:
//   git show main:js/matcher.js > scripts/legacy/matcher-v1.11.0.mjs
