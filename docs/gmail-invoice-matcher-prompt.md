...
1. Per Claude Vision analysiert werden (Händler, Datum, Betrag, Einzelpositionen)
1. Mit einer bestehenden Kontoauszug-Buchung in Firestore gematcht werden
1. Inklusive Sub-Kategorien gespeichert werden (🍫 Süßwaren, 🥛 Milchprodukte, etc.)
...
1. **Starker Match**: Betrag exakt + Datum ±7 Tage → Score 85
1. **Schwacher Match**: Betrag ±2€ + Datum ±5 Tage + Händlername ähnlich → Score 60
1. **Kein Match**: Score < 60 → manuell zuweisen
